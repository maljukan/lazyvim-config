  ...
  opts = {
    ...
    keymaps = {
      view = {
        ...
        { "n", "<leader>e", "<cmd>lua require('diffview.actions').focus_files()<cr>", { desc = "Focus files panel" } },
        { "n", "<leader>b", "<cmd>lua require('diffview.actions').toggle_files()<cr>", { desc = "Toggle files panel" } },
      },
      file_panel = {
